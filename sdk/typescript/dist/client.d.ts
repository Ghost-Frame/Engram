 ...
 */
import type { KleosClientConfig, StoreRequest, StoreResult, SearchRequest, SearchResult, ListOptions, Memory, UpdateRequest, ContextRequest, ContextResult } from './types.js';
/**
 ...
 * ```
 */
export declare class KleosClient {
