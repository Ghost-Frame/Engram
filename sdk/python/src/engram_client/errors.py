...
class KleosError(Exception):
    """Base class for all Kleos client errors."""
...
def raise_for_status(status_code: int, body: dict[str, Any]) -> None:
    ...
    raise KleosError(message, status_code, body)
