"""
KleosClient -- sync and async Python client for the Kleos memory server.

Sync usage::

    from kleos_client import KleosClient

    client = KleosClient("http://localhost:4200", api_key="ek-...")
...
Async usage::
    ...
    async def main():
        client = AsyncKleosClient("http://localhost:4200", api_key="ek-...")
...
from .errors import KleosError, raise_for_status
from .types import (
    Agent,
    AgentPassport,
    ApiKey,
...
class KleosClient:
    """Synchronous Kleos API client.

    Args:
        base_url: Base URL of the Kleos server, e.g. ``http://localhost:4200``.
    ...
    def __enter__(self) -> "KleosClient":
        return self
...
class AsyncKleosClient:
    """Asynchronous Kleos API client (mirrors KleosClient).

    Args:
        base_url: Base URL of the Kleos server.
    ...
    async def __aenter__(self) -> "AsyncKleosClient":
        return self
    ...
    async def store_memory(
        ...
        *,
        ...
        """Async version of :meth:`KleosClient.store_memory`."""
        req = StoreRequest(
            content=content,
            category=category,
            source=source,
    ...
    async def get_memory(self, memory_id: int) -> Memory:
        """Async version of :meth:`KleosClient.get_memory`."""
    ...
    async def list_memories(
        ...
        *,
        ...
        """Async version of :meth:`KleosClient.list_memories`."""
    ...
    async def update_memory(self, memory_id: int, req: UpdateRequest) -> Memory:
        """Async version of :meth:`KleosClient.update_memory`."""
    ...
    async def search(
        ...
        *,
        ...
        """Async version of :meth:`KleosClient.search`."""
        req = SearchRequest(
            query=query,
            limit=limit,
            category=category,
    ...
    async def search_faceted(self, req: FacetedSearchRequest) -> dict[str, Any]:
        """Async version of :meth:`KleosClient.search_faceted`."""
    ...
    async def build_context(
        ...
        *,
        ...
        """Async version of :meth:`KleosClient.build_context`."""
        req = ContextRequest(
            query=query,
            strategy=strategy,  # type: ignore[arg-type]
            mode=mode,  # type: ignore[arg-type]
    ...
    async def list_agents(self) -> list[Agent]:
        """Async version of :meth:`KleosClient.list_agents`."""
    ...
    async def graph_neighborhood(self, memory_id: int, *, depth: Optional[int] = None) -> NeighborhoodResponse:
        """Async version of :meth:`KleosClient.graph_neighborhood`."""
        qs = _qs(depth=depth)
    ...
    async def list_skills(self, *, limit: Optional[int] = None, offset: Optional[int] = None) -> list[SkillRef]:
        """Async version of :meth:`KleosClient.list_skills`."""
        qs = _qs(limit=limit, offset=offset)
    ...
    async def get_skill(self, skill_id: int) -> SkillDetail:
        """Async version of :meth:`KleosClient.get_skill`."""
    ...
    async def batch(self, operations: list[dict[str, Any]]) -> BatchResponse:
        """Async version of :meth:`KleosClient.batch`."""
        req = BatchRequest(operations=operations)  # type: ignore[arg-type]
