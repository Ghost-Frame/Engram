...
- Create: `kleos-lib/src/reranker/pool.rs`
...
- [ ] Add to from_env():
```rust
reranker_pool_size: std::env::var("KLEOS_RERANKER_POOL_SIZE")
    .ok()
...
In `kleos-lib/src/reranker/mod.rs`:
...
- [ ] Run: `cargo test -p kleos-lib`
- [ ] Run: `cargo clippy -p kleos-lib`
...
- Config accepts KLEOS_RERANKER_POOL_SIZE
