...
## Worktree Path
`~/Projects/kleos-wt-G` -- branch `feat/ingestion-parsers`
...
## Source of Truth
- `C:\Users\Zan\Projects\kleos\src\ingestion\parsers\` -- TS parser implementations
- `C:\Users\Zan\Projects\kleos\kleos-lib\src\ingestion\parsers\` -- current Rust stubs

## Files to Modify
- `kleos-lib/src/ingestion/parsers/pdf.rs` (currently 32 lines, stub)
- `kleos-lib/src/ingestion/parsers/docx.rs` (currently 28 lines, stub)
- `kleos-lib/src/ingestion/parsers/zip.rs` (currently 39 lines, stub)
- `kleos-lib/Cargo.toml` (add parser crate dependencies)
...
2. `cargo test -p kleos-lib ingestion` passes (if tests exist)
