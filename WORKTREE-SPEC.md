...
## Worktree Path
`~/Projects/kleos-wt-I` -- branch `feat/lib-completions`

## Goal
Close the remaining lib-level gaps: FSRS decay, grounding backends, jobs system, skills cloud, and docs/openapi route.

## Source of Truth
- `C:\Users\Zan\Projects\kleos\src\fsrs\` -- TS FSRS implementation
- `C:\Users\Zan\Projects\kleos\src\grounding\` -- TS grounding implementation
- `C:\Users\Zan\Projects\kleos\src\jobs\` -- TS jobs implementation
- `C:\Users\Zan\Projects\kleos\src\docs\routes.ts` -- TS docs/openapi routes
- `C:\Users\Zan\Projects\kleos\src\openapi.ts` -- TS openapi spec

## Tasks

### 1. FSRS Decay Review
- File: `kleos-lib/src/fsrs/decay.rs`
...
- Files: `kleos-lib/src/grounding/{client.rs, search.rs, quality.rs, shell.rs}`
...
### 3. Jobs System
- File: `kleos-lib/src/jobs/mod.rs`
...
### 4. Skills Cloud
- File: `kleos-lib/src/skills/cloud.rs` (currently 48 lines)
...
- Modify: `kleos-server/src/routes/mod.rs` (add `pub mod docs;`)
- Modify: `kleos-server/src/server.rs` (wire router)
...
- File: `kleos-server/src/routes/agents.rs`
