...
const ENV_ALLOWED_CMDS: &str = "KLEOS_GROUNDING_ALLOWED_CMDS";
...
const ENV_BASE_DIR: &str = "KLEOS_GROUNDING_BASE_DIR";
...
impl ShellProvider {
    ...
    async fn exec_shell(&self, args: &serde_json::Value, timeout_ms: u64) -> ToolResult {
        ...
        // Drop inherited env so the subprocess can't read KLEOS_* or
        // KLEOS_BOOTSTRAP_SECRET from the parent process.
        cmd.env_clear();
