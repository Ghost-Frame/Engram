...
impl OllamaConfig {
    ...
    /// KLEOS_LLM_URL -- base URL (default: http://127.0.0.1:8080)
    /// KLEOS_LLM_MODEL -- model name (default: mistral-nemo)
    pub fn from_env() -> Self {
        let base_url = std::env::var("KLEOS_LLM_URL")
        ...
        Self {
            url,
            model: std::env::var("KLEOS_LLM_MODEL")
...
mod tests {
    ...
    fn test_config_from_env_defaults() {
        ...
        std::env::remove_var("KLEOS_LLM_MODEL");
