//! Kleos credential management daemon.
//!
...
async fn main() -> anyhow::Result<()> {
    ...
    let _otel_guard =
        kleos_lib::observability::init_tracing("kleos-credd", "kleos_credd=info,tower_http=debug");
    ...
    // KLEOS_ENCRYPTION_MODE controls how the SQLite file itself is encrypted;
