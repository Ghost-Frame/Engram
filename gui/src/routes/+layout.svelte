<script lang="ts">
  ...
  import { apiKey, isAuthed, getHealth } from '$lib/stores/kleos';
  ...
  <nav class="w-52 bg-gray-900/80 border-r border-gray-800 flex flex-col shrink-0">
    <div class="p-4 border-b border-gray-800">
      <h1 class="text-lg font-bold tracking-wider">
        <span class="bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">KLEOS</span>
      </h1>
      {#if health}
