<script lang="ts">
  ...
  import { getGraph, getCommunities, getStats, getMemoryDetail, searchGraph } from '$lib/stores/kleos';
...
<div class="fixed inset-0 z-40 bg-[#0a0a0a] overflow-hidden">
  ...
  {#if !loading && !loadError}
    ...
    <div class="absolute top-0 left-0 right-0 z-50 flex items-center gap-4 px-5 py-3 topbar-gradient">
      ...
      <span class="text-sm font-bold tracking-widest bg-gradient-to-r from-teal-300 to-cyan-400 bg-clip-text text-transparent shrink-0">KLEOS</span>
