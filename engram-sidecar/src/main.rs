...
struct Cli {
    #[arg(short, long, default_value = "7711", env = "KLEOS_SIDECAR_PORT")]
    port: u16,

    #[arg(long, default_value = "127.0.0.1", env = "KLEOS_SIDECAR_HOST")]
    host: String,

    #[arg(long)]
    session_id: Option<String>,

    #[arg(long, default_value = "sidecar", env = "KLEOS_SIDECAR_SOURCE")]
    source: String,

    #[arg(long, default_value = "1", env = "KLEOS_SIDECAR_USER_ID")]
    user_id: i64,
    ...
    #[arg(long, env = "KLEOS_SIDECAR_STORE_PATH")]
    store_path: Option<String>,

    /// Interval (seconds) between persistent-store checkpoints.
    #[arg(long, env = "KLEOS_SIDECAR_STORE_INTERVAL_SECS", default_value = "60")]
    ...
    #[arg(long, env = "KLEOS_SIDECAR_BATCH_SIZE", default_value = "10")]
    batch_size: usize,
    ...
    #[arg(long, env = "KLEOS_SIDECAR_BATCH_INTERVAL_MS", default_value = "2000")]
...
async fn main() {
    ...
    // HTTP client for Kleos server API calls
        ...
        .filter(|s| !s.is_empty())
    {
        ...
        None => {
            ...
            // Use --token flag or KLEOS_SIDECAR_TOKEN env to set explicitly.
            tracing::warn!(
                host = %cli.host,
        ...
        .filter(|s| !s.is_empty())
    {
        ...
        tracing::info!("KLEOS_SIDECAR_STORE_PATH unset -- sessions will not survive restart");
        None
    };
