//! cred-gui -- egui frontend for the kleos-credd credential daemon.
//!
//! Connects to kleos-credd on CREDD_URL (default http://localhost:4400) using
...
// ---------------------------------------------------------------------------
// API types (matches kleos-credd response shapes)
// ---------------------------------------------------------------------------
